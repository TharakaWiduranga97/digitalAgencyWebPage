...
window.addEventListener("scroll", () => {
  if (window.pageYOffset > 500) {
    document.getElementById("main-drop-down-header").style.backgroundColor =
      "white";
    let x = document.getElementById("p-eroo");
    x.style.color = "black";
    document.getElementById("main-dropdown-list").style.backgroundColor =
      "white";
  } else {
    document.getElementById("main-drop-down-header").style.backgroundColor =
      "black";
...
window.addEventListener("scroll", () => {
  if (window.pageYOffset > 500) {
    document.getElementById("nav-outer").style.backgroundColor = "#1a1a1a";
    document.getElementById("nav-outer").style.zIndex = 10;
  } else {
    document.getElementById("nav-outer").style.backgroundColor =
      "rgba(52,73,94,0.1)";
  }
});
...
window.addEventListener("scroll", () => {
  if (window.pageYOffset > 1000 && counter < 1) {
